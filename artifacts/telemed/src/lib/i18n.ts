...
const en = {
  ...
  "avail.sub": "Set the hours you see patients each day. Patients can only book during enabled hours.",
  "avail.enabled": "Available",
  "avail.from": "From",
  "avail.to": "To",
  "avail.save": "Save changes",
  "avail.saved": "Availability updated",
  "avail.invalid": "Start time must be before end time",
  "avail.day.0": "Sunday",
  "avail.day.1": "Monday",
  "avail.day.2": "Tuesday",
  "avail.day.3": "Wednesday",
  "avail.day.4": "Thursday",
  "avail.day.5": "Friday",
  "avail.day.6": "Saturday",
  "demo.tryButton": "Try Live Demo",
  "demo.starting": "Starting…",
  "demo.subline": "No sign-up needed.",
  "demo.asDoctorLink": "Or enter as a doctor →",
  "onb.step1.title": "Care that travels with you",
  "onb.step1.body": "Connect with qualified doctors from your village — no long bus rides, no waiting halls.",
  "onb.step2.title": "Chat, share, get answers",
  "onb.step2.body": "Send messages and photos of prescriptions or rashes. Doctors reply at their earliest.",
  "onb.step3.title": "Help in emergencies",
  "onb.step3.body": "One tap alerts available doctors when you need urgent help. Your details reach them instantly.",
  "onb.next": "Next",
  "onb.skip": "Skip",
...
const hi: Record<keyof typeof en, string> = {
  ...
  "avail.title": "साप्ताहिक उपलब्धता",
  "avail.sub": "हर दिन मरीज़ों को देखने का समय तय करें। मरीज़ केवल सक्षम समय में बुक कर सकते हैं।",
  "avail.enabled": "उपलब्ध",
  "avail.from": "से",
  "avail.to": "तक",
  "avail.save": "बदलाव सहेजें",
  "avail.saved": "उपलब्धता अपडेट हो गई",
  "avail.invalid": "शुरू का समय अंत से पहले होना चाहिए",
  "avail.day.0": "रविवार",
  "avail.day.1": "सोमवार",
  "avail.day.2": "मंगलवार",
  "avail.day.3": "बुधवार",
  "avail.day.4": "गुरुवार",
  "avail.day.5": "शुक्रवार",
  "avail.day.6": "शनिवार",
  "demo.tryButton": "लाइव डेमो आज़माएँ",
  "demo.starting": "शुरू हो रहा है…",
  "demo.subline": "साइन-अप ज़रूरी नहीं।",
  "demo.asDoctorLink": "या डॉक्टर के रूप में देखें →",
  "onb.step1.title": "देखभाल जो आपके साथ चले",
  "onb.step1.body": "अपने गाँव से ही योग्य डॉक्टरों से जुड़ें — लंबी यात्रा नहीं, इंतज़ार नहीं।",
  "onb.step2.title": "चैट करें, साझा करें, जवाब पाएं",
  "onb.step2.body": "संदेश और दवाई या लक्षणों की तस्वीरें भेजें। डॉक्टर जल्द ही जवाब देंगे।",
  "onb.step3.title": "आपातकाल में मदद",
  "onb.step3.body": "एक क्लिक से उपलब्ध डॉक्टरों को सूचित करें। आपकी जानकारी तुरंत उन तक पहुँच जाती है।",
  "onb.next": "आगे",
  "onb.skip": "छोड़ें",
  "onb.start": "शुरू करें",
  "auth.signin": "साइन इन",
